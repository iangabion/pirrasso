...
unset($__errorArgs, $__bag); ?> input_user" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="email">
...
unset($__errorArgs, $__bag); ?> input_pass" name="password" required autocomplete="current-password" placeholder="password">
